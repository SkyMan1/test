							...
							if( $self.hasClass( 'mfilter-select' ) ) {
								...
								(function(){
									...
									for( var i = 0; i < self._selectOptions[seo].length; i++ ) {
										...
										if( self._selectOptions[seo][i].id ) {
											...
											if( first || typeof cnt[idd] != 'undefined' ) {
												$option.html( self._selectOptions[seo][i].name  +   ( ! first && self._options.showNumberOfProducts ? ' (' + cnt[idd] + ' шт) ' : '' ));
												
												add( $option );
											} else {
												/*
												$option.attr('disabled', true).html(  self._selectOptions[seo][i].name + ( self._options.showNumberOfProducts ? '(0 шт)' : '' ) );
									...
									for( var i = 0; i < self._selectOptions[seo].length; i++ ) {
										...
										//	console.log(self._selectOptions[seo][i].value);
