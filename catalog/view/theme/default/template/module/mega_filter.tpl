...
<div class="catalog-wrap-filtr-items box mfilter-box mfilter-box-<?php echo (int) $_idx; ?> mfilter-<?php echo $_position; ?><?php echo ! empty( $hide_container ) ? ' mfilter-hide-container' : '' ?><?php echo ! empty( $_displayOptionsAs ) && $_displayOptionsAs == 'modern_horizontal' ? ' mfilter-hide' : ''; ?>" id="mfilter-box-<?php echo (int) $_idx; ?>">
							...
							<div class="mfilter-content-wrapper<?php echo $display_list_of_items == 'scroll' ? ' mfilter-iscroll' : ''; ?>"<?php echo $display_list_of_items == 'scroll' ? ' style="max-height:' . $mfp_options['display_list_of_items']['max_height'] . 'px"' : ''; ?>>
								<div class="mfilter-options">
									...
									<?php } else if( $filter['type'] == 'price' ) { ?>
										<div class="mfilter-option mfilter-price select_wrap select-range_slider">
											<div class="mfilter-price-inputs range_slider_wrap">
												<?php echo $getSymbolLeft; ?>
											 <div class="range_slider_wrap">  <span class="text-mark">Стоимость :</span>	<input
													id="mfilter-opts-price-min"
													type="text"
													class="form-control amount-slider"
													value="<?php echo isset( $params['price'][0] ) ? $params['price'][0] : ''; ?>"
													
													/></div>
														<div class="mfilter-price-slider">
												<div id="mfilter-price-slider" class="range_slider_wrap range_slider_w"></div>
												
											</div>
												<div class="range_slider_wrap range_slider_wrap-right"><input
													id="mfilter-opts-price-max"
													type="text"
													class="form-control amount-slider amount-slider-right"
									...
									<?php } else if( $filter['type'] == 'select' ) { ?>
										...
										<div class="mfilter-tb">
											...
											<div class="">
              <div class="catalog__select_wrap">
                <div id="" class="select_wrap">
												<?php
												//echo "<pre>";
												//print_r($filter);
												//echo "</pre>";
												?>
												<select data-jcf='{"wrapNative": false, "wrapNativeOnMobile": false, "fakeDropInBody": false, "useCustomScroll": false}' class="catalog__select">
	...
	<div class="nav-filtr-items mfilter-button mfilter-button-bottom">
                 <!-- <button class="reset-btn mfilter-button-reset">Сбросить</button> -->
                 <a href="#" class="reset-btn mfilter-button-reset">Сбросить</a>
              </div>
...
$( document ).ready(function() {
	$('.rem-st > li:nth-child(5)').css({'display':'none'});
	$('.rem-st > li:nth-child(10)').css({'display':'none'});
